...
graph TD
    subgraph "Without Flyweight - 1M objects"
        P1[Particle 1<br/>x, y, velocity<br/>color, sprite ❌]
        P2[Particle 2<br/>x, y, velocity<br/>color, sprite ❌]
        P3[Particle N...<br/>x, y, velocity<br/>color, sprite ❌]
    end
...
<Accordions>
  <Accordion title="✅ Use Flyweight when...">
  ...
  <Accordion title="❌ Avoid Flyweight when...">
