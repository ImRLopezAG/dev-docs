...
flowchart LR
    ...
    subgraph SNS["SNS Topic"]
        T[Topic]
        F1[Filter: eventType=order]
        F2[Filter: eventType=payment]
        F3[Filter: price > 100]
    end
    ...
    style T fill:#553c9a,stroke:#805ad5,color:#fff
    style F1 fill:#2c5282,stroke:#4299e1,color:#fff
    style F2 fill:#276749,stroke:#48bb78,color:#fff
    style F3 fill:#744210,stroke:#d69e2e,color:#fff
    style S1 fill:#285e61,stroke:#38b2ac,color:#fff
    style S2 fill:#285e61,stroke:#38b2ac,color:#fff
    style S3 fill:#285e61,stroke:#38b2ac,color:#fff
```
...
flowchart LR
    ...
    style P fill:#4a5568,stroke:#718096,color:#fff
    style T fill:#553c9a,stroke:#805ad5,color:#fff
    style Q1 fill:#2c5282,stroke:#4299e1,color:#fff
    style Q2 fill:#276749,stroke:#48bb78,color:#fff
    style Q3 fill:#744210,stroke:#d69e2e,color:#fff
    style C1 fill:#285e61,stroke:#38b2ac,color:#fff
    style C2 fill:#285e61,stroke:#38b2ac,color:#fff
    style C3 fill:#285e61,stroke:#38b2ac,color:#fff
```
