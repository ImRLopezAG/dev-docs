...
flowchart TD
    ...
    style A fill:#2c5282,stroke:#4299e1,color:#fff
    ...
    style I fill:#2d3748,stroke:#4a5568,color:#fff
    style J fill:#276749,stroke:#48bb78,color:#fff
...
flowchart LR
    ...
    subgraph Concurrency["Concurrency Types"]
        direction TB
        A[Unreserved]
        B[Reserved]
        C[Provisioned]
    ...
    style R2 fill:#4a5568,stroke:#718096,color:#fff
    style R3 fill:#4a5568,stroke:#718096,color:#fff
    style R4 fill:#4a5568,stroke:#718096,color:#fff
    style A fill:#2d3748,stroke:#4a5568,color:#fff
    style B fill:#2c5282,stroke:#4299e1,color:#fff
    style C fill:#553c9a,stroke:#805ad5,color:#fff
    style E1 fill:#276749,stroke:#48bb78,color:#fff
    style E2 fill:#276749,stroke:#48bb78,color:#fff
    style E3 fill:#276749,stroke:#48bb78,color:#fff
```
