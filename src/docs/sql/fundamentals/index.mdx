...
%%{init: {'theme': 'base', 'themeVariables': { 'primaryColor': '#2c5282', 'primaryTextColor': '#ffffff', 'primaryBorderColor': '#2c5282', 'lineColor': '#4a5568', 'secondaryColor': '#553c9a', 'tertiaryColor': '#285e61'}}}%%
mindmap
  root((SQL))
    DQL
      SELECT
